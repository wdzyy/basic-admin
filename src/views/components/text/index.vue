...
<template>
  <el-card shadow="never">
    ...
    <el-space wrap>
      <ul class="content">
        <li>
          <ZyText :tippy-props="{ content: customContent }">
            props写法 -
            测试文本，这是一个稍微有点长的文本，过长省略后，鼠标悬浮会有tooltip提示
          </ZyText>
        </li>
    ...
    <el-space wrap>
      <ul class="content">
        <li>
          <ZyText type="primary" size="large">
            测试文本，这是一个稍微有点长的文本，过长省略后，鼠标悬浮会有tooltip提示
          </ZyText>
        </li>
        <li>
          <ZyText :line-clamp="4" type="info">
    ...
    <el-space wrap>
      <ul class="content">
        <li>
          <ZyText
            :tippy-props="{ offset: [0, -20], theme: 'light', arrow: false }"
          >
            偏移白色无箭头 -
            测试文本，这是一个稍微有点长的文本，过长省略后，鼠标悬浮会有tooltip提示
          </ZyText>
        ...
        <li>
          <ZyText :line-clamp="4" :tippy-props="{ followCursor: true }">
            鼠标跟随 -
            测试文本，这是一个非常非常长，非常非常长，非常非常长，非常非常长，非常非常长，非常非常长，非常非常长，非常非常长，非常非常长，非常非常长，非常非常长，非常非常长，非常非常长，非常非常长的文本，lineClamp参数为4，即四行过长省略后，鼠标悬浮会有tooltip提示
          </ZyText>
        </li>
    ...
    <el-space wrap>
      <ul class="content">
        <li>
          <ZyText tag="p" :line-clamp="2">
            This is a paragraph. Paragraph start
            <ZyText :truncated="false">
              【 This is ZyText
              <ZyText tag="sup" size="small" :truncated="false">
                superscript 】
              </ZyText>
            </ZyText>
            <el-text>
